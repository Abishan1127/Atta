  ...
  return (
    <Card className="service-card shadow-sm rounded border-0">
      <Card.Body className="text-center service-card-body">
        <small className="service-category text-danger fw-bold text-uppercase">
          {category}
        </small>
      ...
      <div className="service-image-container overflow-hidden ">
        ...
        <div className="service-plus text-center position-relative rounded mx-auto position-relative  d-flex align-items-center justify-content-center ">
          {" "}
        </div>
        <span className="plus-icon text-center mx-auto position-relative rounded-circle d-flex align-items-center justify-content-center ">
          +
        </span>
      </div>
    </Card>
