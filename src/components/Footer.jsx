        ...
        <div className="row gy-4 ">
          ...
          <div className=" col-lg-4 d-flex flex-column align-items-center align-items-lg-start">
            ...
            <div className="mt-4 subscribe-form">
              <p className="mt-0 text-center text-sm-start ">
              ...
              {subscribeError && (
                <small className="text-danger">{subscribeError}</small>
              )}
            </div>
          </div>
                ...
                <div className="carousel-inner p-3 rounded mt-2">
                  <div className="carousel-item active">
                    ...
                    <p className="mb-5 lh-lg">
                      New year celebration by the charm pleasure of the moment
                      and trouble are bound to pleasure of the moment
                    </p>
                  </div>
                  <div className="carousel-item">
                    ...
                    <p className="mb-5 lh-lg">
                      Outdoor concert series continues with local jazz pleasure
                      of the moment and trouble are pleasure of the
                    </p>
                  </div>
                </div>
      ...
      <div className="text-center py-4 border-top border-secondary">
        <small>
          ...
          <span className="text-danger">
            Australian Tamil Accounting Association.
          </span>{" "}
          All Rights Reserved.
        </small>
      </div>
